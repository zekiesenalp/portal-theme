...
<div class="wrap">
    ...
    if($settings['contact'] === 'true')
      $menuItems[] =  ['label' => Module::t('theme','İletişim Formu'), 'url' => ['/iletisim']];
...
$("button[name=contact-button]").attr("disabled","disabled");
var sayi = $("input[name=guvenlik_kodu]").attr("deger");
